...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'https://anime-api-6mg7.onrender.com', 'http://localhost:1234', 'http://localhost:4200', 'https://alqatrony.github.io', 'https://myanimeflix.netlify.app'];
app.use(cors({
