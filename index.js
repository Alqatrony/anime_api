...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'https://myanimed-b.herokuapp.com', 'http://localhost:1234', 'http://localhost:4200', 'https://alqatrony.github.io'];
app.use(cors({
